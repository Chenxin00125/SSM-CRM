...
<div style="position: relative; top: -70px;">
	<div style="position: relative; left: 40px; height: 30px;">
		...
		<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b class="${customer.owner}"></b></div>
	...
	<div style="position: relative; left: 40px; height: 30px; top: 20px;">
		...
		<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b class="${customer.createBy}">&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;">${customer.createTime}</small></div>
		<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
	</div>
	<div style="position: relative; left: 40px; height: 30px; top: 30px;">
		<div style="width: 300px; color: gray;">修改者</div>
		<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b class="${customer.editBy}">&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;">${customer.editTime}</small></div>
		<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
	</div>
